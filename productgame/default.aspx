...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<section class="hero-section" style="margin-top : 100px">
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="./Stylesheet/img/pes21.jpg">
				<div class="container">
					<div class="row">
						<div class="col-xl-6 col-lg-8 text-white">
							<span>TRÒ CHƠI MỚI</span>
							<h2>Pes 2021</h2>
							<p>eFootball Pro Evolution Soccer 2021 là một trò chơi điện tử mô phỏng bóng đá được phát triển bởi PES Productions và được Konami phát hành cho Microsoft Windows, PlayStation 4, Xbox One, Android và iOS.</p>
